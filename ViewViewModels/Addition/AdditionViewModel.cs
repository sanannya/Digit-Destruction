...
using DigitDestruction.ViewViewModels.Addition.AddEntryResults;
...
namespace DigitDestruction.ViewViewModels.Main.Addition
{
    public class AdditionViewModel: BaseViewModel
    {
        ...
        {
            Title = TitlesAddition.AdditionPageTitle;
        ...
        private async void OnEntryClickedAsync(object obj)
        {
            ...
            {
                await Application.Current.MainPage.DisplayAlert(TitlesAddition.AddEntryResultsTitle, "Entry can’t be empty!", "Ok");
                return;
            }
